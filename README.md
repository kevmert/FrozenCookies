...
1. Paste the *contents* (not the url) of https://rawgit.com/kevmert/FrozenCookies/master/frozen_cookies.js into a bookmark.
...
1. Go to https://rawgit.com/kevmert/FrozenCookies/master/fc_userscript_loader.user.js
