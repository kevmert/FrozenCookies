...
1. Paste the *contents* (not the url) of https://rawgit.com/kevmert/FrozenCookies/combined/fc_bookmarklet_loader.js into a bookmark.
...
1. Go to https://rawgit.com/kevmert/FrozenCookies/combined/fc_userscript_loader.user.js
